...
import 'package:karngea4u/features/cv/screens/cv_association/cv_association_card_widget.dart';
...
class CvAssociationScreen extends StatelessWidget {
  const CvAssociationScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CvAssociationCardWidget(
                height: height,
                width: width,
              ),
            )
