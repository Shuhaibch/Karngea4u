...
class CvAssociationTextFormScreen extends StatefulWidget {
  const CvAssociationTextFormScreen({super.key});

  @override
  State<CvAssociationTextFormScreen> createState() =>
      _CvAssociationTextFormScreenState();
}

class _CvAssociationTextFormScreenState
    extends State<CvAssociationTextFormScreen> {
  ...
  TextEditingController awardCTRL = TextEditingController();
