...
import 'package:karngea4u/features/cv/screens/cv_attachments/cv_attachments_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_attachments/cv_attachments_text_form_screen.dart';
import 'package:karngea4u/features/cv/widgets/cv_basic_details_header_icon_widget.dart';

class CvAttachmentsScreen extends StatelessWidget {
  const CvAttachmentsScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CvAttachmentsCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvAttachmentsTextFormScreen(),
              ));
        },
