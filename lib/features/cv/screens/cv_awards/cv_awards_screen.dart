...
import 'package:karngea4u/features/cv/screens/cv_awards/cv_awards_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_awards/cv_awards_text_form_screen.dart';
import 'package:karngea4u/features/cv/widgets/cv_basic_details_header_icon_widget.dart';

class CvAwardScreen extends StatelessWidget {
  const CvAwardScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CvAwardCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvAwardTextFormScreen(),
              ));
        },
