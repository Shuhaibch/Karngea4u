...
class CvVideoTextFormScreen extends StatefulWidget {
  const CvVideoTextFormScreen({super.key});

  @override
  State<CvVideoTextFormScreen> createState() => _CvVideoTextFormScreenState();
}

class _CvVideoTextFormScreenState extends State<CvVideoTextFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CAppbar(
        ...
        title: Text('VIDEO', style: Theme.of(context).textTheme.titleMedium!),
