...
class CvProjectsTextFormScreen extends StatefulWidget {
  const CvProjectsTextFormScreen({super.key});

  @override
  State<CvProjectsTextFormScreen> createState() =>
      _CvProjectsTextFormScreenState();
}

class _CvProjectsTextFormScreenState extends State<CvProjectsTextFormScreen> {
  ...
  TextEditingController projextTitleCTRL = TextEditingController();
