...
import 'package:karngea4u/features/cv/screens/cv_professional_skills/cv_pro_skills_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_professional_skills/cv_pro_skills_text_form_screen.dart';
import 'package:karngea4u/features/cv/widgets/cv_basic_details_header_icon_widget.dart';

class CvProSkillsScreen extends StatelessWidget {
  const CvProSkillsScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CVProSkillsCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvProSkillsTextFormScreen(),
              ));
        },
