...
class CvMembersTextFormScreen extends StatefulWidget {
  const CvMembersTextFormScreen({super.key});

  @override
  State<CvMembersTextFormScreen> createState() =>
      _CvMembersTextFormScreenState();
}

class _CvMembersTextFormScreenState extends State<CvMembersTextFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CAppbar(
        ...
        title: Text('MEMBER', style: Theme.of(context).textTheme.titleMedium!),
