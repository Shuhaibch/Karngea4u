...
import 'package:karngea4u/features/cv/screens/cv_members/cv_members_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_members/cv_members_text_form_screen.dart';
import 'package:karngea4u/features/cv/widgets/cv_basic_details_header_icon_widget.dart';

class CvMembersScreen extends StatelessWidget {
  const CvMembersScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CvMembersCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvMembersTextFormScreen(),
              ));
        },
