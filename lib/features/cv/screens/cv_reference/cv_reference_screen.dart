...
import 'package:karngea4u/features/cv/screens/cv_reference/cv_reference_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_reference/cv_reference_text_form_screen.dart';
import 'package:karngea4u/features/cv/widgets/cv_basic_details_header_icon_widget.dart';

class CvReferenceScreen extends StatelessWidget {
  const CvReferenceScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CvReferenceCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvReferenceTextFormScreen(),
              ));
        },
