...
class CvPublicationTextFormScreen extends StatefulWidget {
  const CvPublicationTextFormScreen({super.key});

  @override
  State<CvPublicationTextFormScreen> createState() =>
      _CvPublicationTextFormScreenState();
}

class _CvPublicationTextFormScreenState
    extends State<CvPublicationTextFormScreen> {
