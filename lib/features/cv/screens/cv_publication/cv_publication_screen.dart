...
import 'package:karngea4u/features/cv/screens/cv_publication/cv_publication_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_publication/cv_publication_text_form_screen.dart';
import 'package:karngea4u/features/cv/widgets/cv_basic_details_header_icon_widget.dart';

class CvPublicationScreen extends StatelessWidget {
  const CvPublicationScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CvPublicationCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvPublicationTextFormScreen(),
              ));
        },
