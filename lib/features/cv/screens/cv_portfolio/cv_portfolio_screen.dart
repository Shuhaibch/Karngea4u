...
import 'package:karngea4u/features/cv/screens/cv_portfolio/cv_portfolio_card_widget.dart';
import 'package:karngea4u/features/cv/screens/cv_portfolio/cv_portfolio_text_form_screen.dart';
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: 10,
              itemBuilder: (context, index) => CVPortfolioCardWidget(
                height: height,
                width: width,
              ),
            )
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CvPortfolioTextFormScreen(),
              ));
        },
